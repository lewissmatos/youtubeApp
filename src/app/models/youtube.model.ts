// To parse this data:
//
//   import { Convert, YoutubeResponseJSON } from "./file";
//
//   const youtubeResponseJSON = Convert.toYoutubeResponseJSON(json);
//
...
export class Convert {
  public static toYoutubeResponseJSON(json: string): YoutubeResponse {
    return cast(JSON.parse(json), r("YoutubeResponseJSON"));
  }

  public static youtubeResponseJSONToJson(value: YoutubeResponse): string {
    return JSON.stringify(uncast(value, r("YoutubeResponseJSON")), null, 2);
  }
}
